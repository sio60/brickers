...
import com.brickers.backend.admin.job.service.AdminJobService;
...
public class AdminJobController {
    ...
    /** 작업 상세 */
    @GetMapping("/{jobId}")
    public AdminJobDto getJob(@PathVariable String jobId) {
    ...
    public AdminJobDto cancelJob(@PathVariable String jobId) {
