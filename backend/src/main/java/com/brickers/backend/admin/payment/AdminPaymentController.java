...
public class AdminPaymentController {
    ...
    public AdminPaymentDto getOrder(@PathVariable String orderId) {
        return adminPaymentService.getOrder(orderId);
    }

    /** 결제 취소 (Admin 기능) */
    @PostMapping("/orders/{orderId}/cancel")
    public AdminPaymentDto cancelOrder(@PathVariable String orderId, @RequestBody Map<String, String> body) {
        try {
